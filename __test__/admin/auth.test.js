...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Marcel_Jones9',
      password: '26FPb4vKaANuJd8',
      email: 'Zackery.Rau92@gmail.com',
      name: 'Olivia Stoltenberg',
      userType: 283,
      mobileNo: '1-600-821-3641 x11888',
      resetPasswordLink: {},
      loginRetryLimit: 37,
      loginReactiveTime: '2022-11-07T08:51:04.462Z',
      id: '623b0c9d6040f366bddd1665'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Gladys.Hyatt',
        'password':'OMYo43Y907Cf_uA',
        'email':'Marion88@gmail.com',
        'name':'Mrs. Kyle Beer',
        'userType':authConstant.USER_TYPES.Admin,
        'mobileNo':'842.777.9118 x57748',
